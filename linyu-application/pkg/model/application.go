...
type Application struct {
	...
	PluginSha256      string              `gorm:"size:64;comment:插件sha256" json:"pluginSha256"`
	PluginSignature   string              `gorm:"type:text;comment:插件签名" json:"pluginSignature"`
	PluginPermissions json.RawMessage     `gorm:"type:text;serializer:json;comment:插件权限" json:"pluginPermissions"`
